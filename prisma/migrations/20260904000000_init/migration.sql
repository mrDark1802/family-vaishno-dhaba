...
-- CreateEnum
CREATE TYPE "RegionalCuisine" AS ENUM ('PUNJABI', 'HIMACHALI', 'COMMON');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('UPI', 'CARD', 'NETBANKING', 'CASH_ON_DELIVERY');
...
CREATE TABLE "addresses" (
    ...
    "city" TEXT NOT NULL DEFAULT 'Kangra',
...
CREATE TABLE "products" (
    ...
    "cuisine" "RegionalCuisine" NOT NULL DEFAULT 'COMMON',
    "isSpicy" BOOLEAN NOT NULL DEFAULT false,
    "preparationTime" TEXT DEFAULT '15-20 mins',
...
-- CreateIndex
CREATE INDEX "products_cuisine_idx" ON "products"("cuisine");

-- CreateIndex
CREATE INDEX "products_isAvailable_idx" ON "products"("isAvailable");

-- CreateIndex
CREATE INDEX "products_isChefSpecial_idx" ON "products"("isChefSpecial");
